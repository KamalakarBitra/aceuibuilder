    ...
    return function(t) {
        ...
        var T = function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                o = e.style,
                a = "tabs",
                i = '<div ty="multi_component_tab" data-gjs-type="'.concat(a, '"></div>\n    ').concat(o ? "<style>".concat(o, "</style>") : "");
            r && n.add(a, P({
        ...
        var S = "data-tab";
        var prop = "ty=multi_component_tab"

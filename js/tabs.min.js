/*! grapesjs-tabs - 0.2.1 */ ! function(t, e) {
    ...
    return function(t) {
        ...
        var T = function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                o = e.style,
                a = "tabs",
                i = '<div data-gjs-type="'.concat(a, '"></div>\n    ').concat(o ? "<style>".concat(o, "</style>") : "");
            r && n.add(a, P({
        ...
        e.default = function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                n = x({}, {
                    ...
                    selectorTab: "href",
                    template: "\n <div class='row' style='height: 570px;'> <nav    ".concat("data-tab-container", '>\n      <div class="col-sm-3"><li>  <a href="#tab1" ').concat(S, '>Tab 1</a></li>\n        <li><a href="#tab2" ').concat(S, '>Tab 2</a></li>\n        <li><a href="#tab3" ').concat(S, '>Tab 3</a></li></div>\n      </nav>\n     <div class="col-sm-9"> <div id="tab1" ').concat("data-tab-content", '>\n        <div></div>\n      </div>\n      <div id="tab2" ').concat("data-tab-content", '>\n        <div></div>\n      </div>\n      <div id="tab3" ').concat("data-tab-content", ">\n        <div></div>\n      </div></div></div>\n    "),
                    templateTabContent: "",
